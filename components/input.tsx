...
export const meta: ComponentMeta<InputProps> = {
	name: "Input",
	description:
		"Form input component with built-in label, validation feedback, and helper text support. Supports multiple variants: text, email, password (with toggle), textarea (with autoresize), tags (multi-value input), and combobox. Can be used standalone or with labels and validation.",
	...
	examples: [
		...
		{
			title: "With Validation States",
			description: "Input fields with error and success validation feedback",
			code: () => (
				<div class="space-y-4 max-w-md">
					<Input
						label="Email"
		...
		{
			title: "Basic Input (No Label)",
			description: "Standalone inputs without labels",
			code: () => (
				<div class="space-y-4">
		...
		},
		{
			...
			code: () => <Input type="textarea" autoresize placeholder="Enter your message..." />,
		},
		{
			title: "Tags Input",
			description: "Input for adding multiple tags",
			code: () => (
				<Input type="tags" defaultValue={["React", "Solid", "Vue"]} placeholder="Add skill..." />
			),
		},
		{
