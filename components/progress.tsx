		...
		>
			{(props.label || props.showValue) && (
				<div class="flex items-center justify-between">
					...
					{props.showValue && <ArkProgress.ValueText class="text-sm text-muted-foreground" />}
				</div>
			)}
			{variant === "circular" ? (
...
export const meta: ComponentMeta<ProgressProps> = {
	...
	apiReference: "https://ark-ui.com/docs/components/progress-linear#api-reference",
	...
	examples: [
		{
			...
			code: () => {
				...
				return (
					<Progress id="progress-linear" label="Loading" value={progress()} variant="linear" />
				);
			},
		},
		{
			...
			code: () => {
				...
				return (
					<Progress id="progress-circular" label="Loading" value={progress()} variant="circular" />
				);
			},
		},
		{
