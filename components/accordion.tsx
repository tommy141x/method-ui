      ...
      code: () => (
        <Accordion defaultValue={["react"]}>
          ...
          <AccordionItem value="solid">
            ...
            <AccordionContent>
              <span class="text-muted-foreground">
                SolidJS is a declarative, efficient, and flexible JavaScript
                library for building user interfaces with fine-grained
                reactivity.
              </span>
            </AccordionContent>
          </AccordionItem>
      ...
      code: () => (
        <Accordion collapsible defaultValue={["react"]}>
          <AccordionItem value="react">
            ...
            <AccordionContent>
              <span class="text-muted-foreground">
                Yes! With the collapsible prop, you can close all accordion
                items by clicking the open item.
              </span>
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="solid">
            ...
            <AccordionContent>
              <span class="text-muted-foreground">
                Absolutely. The accordion uses smooth CSS animations for opening
                and closing.
              </span>
            </AccordionContent>
          </AccordionItem>
      ...
      code: () => (
        <Accordion multiple defaultValue={["react", "solid"]}>
          <AccordionItem value="react">
            ...
            <AccordionContent>
              <span class="text-muted-foreground">
                Full keyboard navigation, collapsible items, and smooth
                animations built-in.
              </span>
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="solid">
            ...
            <AccordionContent>
              <span class="text-muted-foreground">
                Complies with WAI-ARIA design patterns and supports screen
                readers.
              </span>
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="vue">
            ...
            <AccordionContent>
              <span class="text-muted-foreground">
                Fully customizable with Tailwind CSS and class variance
                authority.
              </span>
            </AccordionContent>
          </AccordionItem>
      ...
      code: () => (
        <Accordion defaultValue={["installation"]}>
          ...
          <AccordionItem value="usage" variant="outlined">
            ...
            <AccordionContent variant="outlined">
              <span class="text-muted-foreground">
                Import the components and start building your accordion UI with
          ...
          <AccordionItem value="customization" variant="outlined">
            ...
            <AccordionContent variant="outlined">
              <span class="text-muted-foreground">
                Use CVA variants and Tailwind classes to customize the look and
                feel.
              </span>
            </AccordionContent>
          </AccordionItem>
      ...
      code: () => (
        <Accordion defaultValue={["available"]}>
          ...
          <AccordionItem value="enabled">
            ...
            <AccordionContent>
              <span class="text-muted-foreground">
                This accordion item is also available.
              </span>
            </AccordionContent>
          </AccordionItem>
        </Accordion>
