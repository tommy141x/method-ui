...
const awardVariants = cva("", {
  variants: {
    variant: {
      ...
      award:
        "relative z-0 flex flex-col items-center justify-center p-6 overflow-hidden",
      certificate:
  ...
  return (
    <div class={cn(awardVariants({ variant: "stamp" }), props.class)}>
      ...
      <div class="relative z-10 text-center">
        ...
        {props.recipient && (
          <div class="text-primary mt-2 text-[14px]">{props.recipient}</div>
        )}
      ...
      <div class="z-10 px-8 text-center">
        <div
          class={cn(
            ...
            `bg-gradient-to-r ${levelColors[props.level || "gold"]}`,
          )}
        >
        ...
        <div class="bg-primary mx-auto my-3 h-[1px] w-40"></div>

        <h2 class="mb-4 w-60 text-xl font-light">{props.subtitle}</h2>

        {props.recipient && (
          <p class="text-primary/60 italic">{props.recipient}</p>
        )}
  ...
  return (
    <div class={cn(awardVariants({ variant: "certificate" }), props.class)}>
      <div class="bg-card z-10 rounded-sm border p-6 px-8 text-center">
        ...
        <p class="text-muted-foreground mt-4 mb-1 text-xs">
    ...
    <div class={cn(awardVariants({ variant: "badge" }), props.class)}>
      <div class="rounded-md border-4 p-4 flex justify-start gap-3">
        ...
        <div class="border-l px-3">
          ...
          <h2 class="text-muted-foreground text-md font-light">
            {props.subtitle}
          </h2>
