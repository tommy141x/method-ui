...
export const meta: ComponentMeta<BadgeProps> = {
	...
	examples: [
		...
		},
		{
			...
			code: () => (
				<div class="flex flex-wrap gap-2">
					...
					<Badge class="h-5 min-w-5 rounded-full px-1 font-mono tabular-nums" variant="secondary">
						3
					</Badge>
				</div>
			),
		},
		{
			...
			code: () => (
				<div class="flex flex-wrap gap-2">
					<Badge class="bg-green-500 text-white hover:bg-green-600">Success</Badge>
					<Badge class="bg-yellow-500 text-white hover:bg-yellow-600">Warning</Badge>
					<Badge class="bg-purple-500 text-white hover:bg-purple-600">Info</Badge>
					<Badge class="bg-orange-500 text-white hover:bg-orange-600">Pending</Badge>
				</div>
			),
		},
		{
