...
export const Drawer = (props: DrawerProps) => {
  ...
  const [internalOpen, setInternalOpen] = createSignal(
    merged.open ?? merged.defaultOpen,
  );
...
export const DrawerContent = (props: DrawerContentProps) => {
  ...
  const handleDragEnd = (e: MouseEvent | TouchEvent, clientPos: number) => {
    ...
    const shouldClose =
      ...
      (percentage > context.dismissThreshold ||
        velocity > context.velocityThreshold);
      ...
      <Show when={context.open()}>
        <Motion.div
          ...
          class={cn(
            ...
            context.side() === "left" && [
              "inset-y-0 left-0 w-3/4 max-w-sm border-l-0",
            ],
            context.side() === "right" && [
              "inset-y-0 right-0 w-3/4 max-w-sm border-r-0",
            ],
            local.class,
          )}
...
export const DrawerHeader = (props: DrawerHeaderProps) => {
  ...
  return (
    <div
      class={cn("flex flex-col gap-1.5 p-4 text-left", local.class)}
      {...others}
    />
  );
};
...
export const DrawerBody = (props: DrawerBodyProps) => {
  ...
  return (
    <div class={cn("flex-1 overflow-y-auto p-4", local.class)} {...others} />
  );
};
          ...
          <DrawerPortal>
            <DrawerContent>
              <DrawerHeader>
                ...
                <DrawerDescription>
                  This is a drawer that slides in from the bottom. Drag it down
                  to dismiss.
                </DrawerDescription>
              </DrawerHeader>
              <DrawerBody>
          ...
          <DrawerPortal>
            <DrawerContent>
              ...
              <DrawerBody>
                <div class="space-y-2">
                  <p class="text-sm">
                    🎉 New features have been released! Check out our latest
                    updates.
                  </p>
                  <p class="text-sm text-muted-foreground">
                    Drag up to dismiss this notification.
                  </p>
                </div>
              </DrawerBody>
            </DrawerContent>
            ...
            >
              <DrawerPortal>
                <DrawerContent>
                  ...
                  <DrawerBody>
                    <p class="text-sm">
                      You can control this drawer using the buttons above.
                    </p>
                  </DrawerBody>
                  <DrawerFooter>
