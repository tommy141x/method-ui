...
export const Card3D: Component<Card3DProps> = (props) => {
	const [local, others] = splitProps(props, ["children", "class", "intensity", "disabled"]);
						...
						<div class="rounded-2xl bg-card border border-border overflow-hidden">
							...
							<div class="p-6">
								...
								<p class="text-muted-foreground mb-4">
									Experience the next level of interaction with this premium 3D card component.
								</p>
					...
					<Card3D class="w-[350px]">
						<div class="rounded-2xl bg-linear-to-br from-purple-500 to-pink-500 p-8 text-white">
							...
							<div class="flex gap-2">
								<div class="px-3 py-1 rounded-full bg-white/20 text-sm">Interactive</div>
								<div class="px-3 py-1 rounded-full bg-white/20 text-sm">3D Effect</div>
							</div>
						</div>
					</Card3D>
				</div>
