...
export const Highlighter: Component<HighlighterProps> = (props) => {
	...
	return (
		...
		>
			<span ref={setElementRef} class={cn("relative inline-block", local.class)} {...others}>
				{local.children}
			</span>
		</Show>
	);
	...
	examples: [
		{
			...
			code: () => (
				<div class="text-center p-8">
					<p class="text-xl">
						This is <Highlighter color="hsl(var(--muted))">highlighted text</Highlighter> with an{" "}
		...
		},
		{
			...
			code: () => (
				<div class="flex flex-col gap-6 p-8">
					<p class="text-xl">
						<Highlighter type="highlight" color="#ec4899" strokeWidth={4} animationDuration={1200}>
							Bold pink highlight
						</Highlighter>
					</p>
					<p class="text-xl">
						<Highlighter type="underline" color="#06b6d4" strokeWidth={3} iterations={3}>
							Triple underline
						</Highlighter>
					</p>
					<p class="text-xl">
						<Highlighter type="box" color="#f97316" strokeWidth={2} padding={10}>
