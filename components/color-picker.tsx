...
interface ColorPickerProps {
  ...
  value?: any; // Color type from Ark UI
  defaultValue?: any; // Color type from Ark UI
  onValueChange?: (details: { value: any; valueAsString: string }) => void;
  onValueChangeEnd?: (details: { value: any; valueAsString: string }) => void;
...
const ColorPickerPositioner: Component<{
  ...
  return (
    <Portal>
      <ArkColorPicker.Positioner class={props.class}>
        {props.children}
      </ArkColorPicker.Positioner>
    </Portal>
  );
...
const ColorPickerArea: Component<{
  ...
  return (
    <ArkColorPicker.Area
      class={cn(
        "h-40 w-full rounded-lg border border-border relative",
        local.class,
      )}
      {...others}
    >
...
const ColorPickerAreaBackground: Component<{ class?: string }> = (props) => {
  return (
    <ArkColorPicker.AreaBackground class={cn("h-full w-full", props.class)} />
  );
};
...
const ColorPickerChannelSliderTrack: Component<{ class?: string }> = (
  props,
) => {
  return <ArkColorPicker.ChannelSliderTrack class={cn(props.class)} />;
};

const ColorPickerChannelSliderThumb: Component<{ class?: string }> = (
  props,
) => {
...
export const meta: ComponentMeta<ColorPickerProps> = {
  ...
  examples: [
    ...
    },
    {
      ...
      description:
        "Build custom layouts using composable parts with custom preset colors",
      code: () => {
        return (
