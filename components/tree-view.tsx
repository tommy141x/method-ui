...
export const TreeView: Component<TreeViewProps> = (props) => {
	...
	return (
		<ArkTreeView.Root class={cn("w-full", local.class)} collection={treeCollection()} {...others}>
			{local.label && (
				<ArkTreeView.Label class="text-sm font-semibold mb-2">{local.label}</ArkTreeView.Label>
			)}
