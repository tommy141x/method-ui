...
export const meta: ComponentMeta<NavMenuProps> = {
  name: "NavMenu",
  description:
    "A responsive navigation menu component with hover/click interactions, keyboard navigation, and smooth animations. Perfect for site headers and navigation bars.",
  examples: [
    {
      title: "Basic Navbar",
              ...
              <NavMenuContent class="p-2">
                <div class="flex gap-2">
                  ...
                  <div class="w-[280px] flex flex-col gap-1">
                    ...
                    >
                      <div
                        class={cn("h-5 w-5 mt-0.5", icon("layout-dashboard"))}
                      />
                      <div>
...

    {
      ...
      description: "Navigation without viewport for inline content",
      code: () => (
            ...
            <NavMenuItem>
              ...
              <NavMenuContent class="p-2">
                <div class="flex flex-col gap-1 w-[200px]">
                  <a
                    href="#about-us"
                    class="rounded-md p-3 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground"
                  >
                    About Us
                  </a>
                  <a
    ...
    },
    {
      ...
      description: "Complete navigation with branding and CTA",
      code: () => (
        <NavMenu>
          <NavMenuList>
            <NavMenuItem>
            ...
            <NavMenuItem>
              <NavMenuLink href="#docs">Docs</NavMenuLink>
            </NavMenuItem>
            <NavMenuItem>
