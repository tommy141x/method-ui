...
export const FloatingPanel = (props: FloatingPanelProps) => {
	return <ArkFloatingPanel.Root {...props}>{props.children}</ArkFloatingPanel.Root>;
};
	...
	return (
		<ArkFloatingPanel.Context>
			{(context) => {
				...
				return (
					<Portal>
						<ArkFloatingPanel.Positioner style={{ "z-index": local.zIndex ?? 100 }}>
							...
							>
								...
								<Show when={local.showMaximize !== false || local.showMinimize !== false}>
				...
				<FloatingPanel defaultOpen={false}>
					...
					<FloatingPanelContent title="Floating Panel">
						<p class="text-sm text-muted-foreground">
							This is a draggable and resizable floating panel. You can drag it by the header and
		...
		},
		{
			...
			code: () => (
				...
				>
					...
					<FloatingPanelContent title="Support Chat" headerClass="bg-primary/5" zIndex={150}>
						...
						<div class="space-y-3">
							<div class="flex gap-3 p-2 rounded-md hover:bg-accent">
								...
								<div>
									...
									<p class="text-xs text-muted-foreground">You have a new message from John</p>
								</div>
							</div>
							<div class="flex gap-3 p-2 rounded-md hover:bg-accent">
