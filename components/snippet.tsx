...
export const Snippet: Component<SnippetProps> = (props) => {
  ...
  return (
    <Tabs
      class={cn("group w-full gap-0 overflow-hidden rounded-md", local.class)}
      {...others}
    >
      {local.children}
    </Tabs>
...
export const SnippetHeader: Component<SnippetHeaderProps> = (props) => {
  ...
  return (
    <div
      class={cn(
        "flex flex-row items-center justify-between bg-card p-1",
        local.class,
      )}
      {...others}
    >
...
export const SnippetTabsTrigger: Component<SnippetTabsTriggerProps> = (
  props,
) => {
...
export const SnippetTabsContent: Component<SnippetTabsContentProps> = (
  props,
) => {
  const [local, others] = splitProps(props, ["children", "class"]);
  ...
  return (
    <TabsContent
      class={cn("!mt-0 bg-muted p-4 text-sm", local.class)}
      {...others}
    >
      ...
      code: () => (
        <Snippet defaultValue="npm" class="max-w-2xl">
          ...
          <SnippetTabsContent value="npm">
            npm install @method-ui/core
          </SnippetTabsContent>
          <SnippetTabsContent value="yarn">
            yarn add @method-ui/core
          </SnippetTabsContent>
          <SnippetTabsContent value="pnpm">
            pnpm add @method-ui/core
          </SnippetTabsContent>
          <SnippetTabsContent value="bun">
            bun add @method-ui/core
          </SnippetTabsContent>
        </Snippet>
      ),
    },
  ...
  version: "1.0.0"
        ...
        return (
          <Snippet defaultValue="component" class="max-w-2xl">
            ...
            <SnippetTabsContent value="component">
              {componentCode}
            </SnippetTabsContent>
