                ...
                <div class="grid gap-4">
                  <div class="flex gap-3">
                    ...
                    <div>
                      ...
                      <p class="text-sm text-muted-foreground">
                        All themes are equal. There's no hardcoded "light" or
                        "dark" logic - just themes.
                      </p>
                    </div>
                  </div>
                  <div class="flex gap-3">
                  ...
                  <div class="flex gap-3">
                    ...
                    <div>
                      ...
                      <p class="text-sm text-muted-foreground">
                        Define only what you want to change. Unspecified
                        variables automatically inherit from :root.
                      </p>
                    </div>
                  </div>
                  <div class="flex gap-3">
                    ...
                    <div>
                      ...
                      <p class="text-sm text-muted-foreground">
                        Define themes in CSS files or inline in your code -
                ...
                <div>
                  ...
                  <div class="space-y-3 text-sm">
                    <div class="flex gap-3">
                      ...
                      <div>
                        <strong>CSS Classes:</strong> When using CSS-defined
                        themes, all classes in the inheritance chain are applied
                        unless the theme ID is 'base' which uses :root (e.g.,{" "}
                    ...
                    <div class="flex gap-3">
                      <div class="i-lucide-arrow-right size-5 text-primary flex-shrink-0 mt-0.5" />
                      <div>
                        <strong>Inline cssVars:</strong> Variables are
                        recursively merged, with child themes overriding parent
                        values
                      </div>
                    </div>
                    <div class="flex gap-3">
                      <div class="i-lucide-arrow-right size-5 text-primary flex-shrink-0 mt-0.5" />
                      <div>
                        <strong>Recursive:</strong> Themes can extend themes
                        that extend other themes (e.g., modern → dark → base)
                      </div>
                    </div>
                    <div class="flex gap-3">
                      <div class="i-lucide-arrow-right size-5 text-primary flex-shrink-0 mt-0.5" />
                ...
                <div class="bg-green-500/10 border border-green-500/20 p-4 rounded-lg">
                  <div class="flex gap-2 items-start">
                    ...
                    <div class="text-sm">
                      ...
                      themes. For example, create "rose-light" and "rose-dark"
                      that extend "light" and "dark" respectively.
                    </div>
                  </div>
                </div>
              </CardContent>
  ...
  <App />
                ...
                <div class="bg-blue-500/10 border border-blue-500/20 p-4 rounded-lg">
                  <div class="flex gap-2 items-start">
                    ...
                    <div class="text-sm">
                      <strong class="text-blue-500">Note:</strong> Inline
                      cssVars override CSS-defined themes. If a theme has both a
                      CSS class and cssVars, the cssVars take precedence.
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent class="space-y-4">
                <div class="flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-muted-foreground">
                      Theme classes only need to define variables that differ
                      from :root. Everything else automatically inherits.
                    </p>
  ...
  /* All other vars inherit from :root */
                ...
                <div class="flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-muted-foreground">
                      HSL (Hue Saturation Lightness) makes it easier to create
                      color variations and maintain consistency.
                    </p>
                    <div class="mt-2 bg-muted p-3 rounded font-mono text-xs">
                      <pre>{`/* ✅ Good */
...
--primary: #3b82f6;`}</pre>
                ...
                <div class="flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-muted-foreground">
                      Make sure your custom color themes work well when layered
                      on different base themes (like light and dark).
                    </p>
                  </div>
                </div>
                ...
                <div class="flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-muted-foreground">
                      ...
                      theme. Only define what changes. The CSS cascade handles
                      the rest.
                    </p>
                  </div>
                </div>
              ...
              <CardContent class="space-y-6">
                <div>
                  ...
                  <div class="bg-muted p-4 rounded-lg font-mono text-xs space-y-2">
                    ...
                    <div>
                      <strong>config.storageKey</strong>?: string (default:
                      "theme")
                    </div>
                    <div>
                ...
                <div>
                  ...
                  <div class="bg-muted p-4 rounded-lg font-mono text-xs space-y-2">
                    ...
                    <div>
                      <strong>currentTheme()</strong>: ThemeDefinition |
                      undefined
                    </div>
                    <div>
                      <strong>mounted()</strong>: boolean - Is client-side
                      mounted
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div class="bg-muted p-4 rounded-lg font-mono text-xs space-y-2">
                    ...
                    <div>
                      <strong>cssVars</strong>?: Record&lt;string, string&gt; -
                      CSS variable overrides
                    </div>
                    <div>
                      <strong>extends</strong>?: string - Base theme ID to
                      inherit from
                    </div>
                  </div>
                </div>
